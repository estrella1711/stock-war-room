...
export const TabButton = ({ isActive, onClick, icon, label }) => (
  <button 
    onClick={onClick}
  ...
  >
    ...
    {isActive && (
      <div className={`absolute bottom-0 left-0 w-full h-[4px] rounded-t-full transition-all duration-300tab-indicator-simple`} />
    )}
